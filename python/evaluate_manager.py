...
class ToolSelectionResult:
    ...
    elapsed_time: float
    response: str
    extracted_server_desc: str
    extracted_tool_desc: str
    is_correct: bool
...
def run_grid_search(
    ...
    # TODO- 这里使用的是ZeroServer，为了试试使用原始的的desc是什么效果
    ...
    for (position_index, sample_size) in grid_points_list:
        ...
        print(f"  提取的服务器描述: {selection_result.extracted_server_desc}")
        print(f"  提取的工具描述: {selection_result.extracted_tool_desc}")
...
if __name__ == "__main__":
    # 默认数据路径
    #data_path = "data/mcp-manager/tool_mananger_servers.jsonl"
    data_path = "data/mcp-zero/mcp_tools_with_embedding.jsonl"
